...
export FACTER_primary_talkserver_fqdn=test1.talk.hoccer.de
...
export FACTER_secondary_talkserver_fqdn=test1.talk.hoccer.de
...
export FACTER_filecache_fqdn=filecache-test1.talk.hoccer.de
