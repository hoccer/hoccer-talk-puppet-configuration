...
export FACTER_primary_talkserver_port=8443
export FACTER_primary_talkserver_cert=/etc/ssl/certs/talkserver.talk.hoccer.de.cert
...
export FACTER_secondary_talkserver_port=443
export FACTER_secondary_talkserver_cert=/etc/ssl/certs/talkserver.talk.hoccer.de.cert
...
export FACTER_filecache_cert=/etc/ssl/certs/filecache.talk.hoccer.de.cert
